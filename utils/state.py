...
def seed_tasks():
    def t(title, cell, pri, assignee, due_offset, status, shared=False, desc=""):
        return {"id": new_id(), "title": title, "cell": cell, "pri": pri,
                "assignee": assignee, "due": today_str(due_offset),
                "status": status, "desc": desc, "shared": shared, "shared_branch": False}

    return [
        # ── 마케팅 유닛 (10) ─────────────────────────────────────
        t("6월 여름 프로모션 기획서 작성", "marketing", "H", "이지우", 2, "inprog", True,
          "여름 시즌 전층 동시 프로모션 테마 및 실행 계획 수립. SNS 캠페인·카카오채널·VMD 연계 방안 포함. 팀장 최종 보고 후 확정 예정."),
        t("카카오톡 발송 리스트 정제", "marketing", "M", "김보람", 4, "inprog",
          desc="6월 프로모션 고객 세그먼트별 발송 리스트 정리. 이탈 고객·중복 번호 제거, 수신 동의 고객 기준 최종 리스트 완성."),
        t("SNS 인스타그램 여름 컨텐츠 기획", "marketing", "M", "신석호", 8, "todo",
          desc="피드·릴스·스토리 채널별 여름 콘텐츠 3종 기획. 트렌드 해시태그 조사 및 경쟁사 벤치마킹 후 기획안 작성."),
        t("7월 VIP 고객 초청 행사 준비", "marketing", "H", "백서희", 14, "todo",
          desc="VIP 고객 200명 대상 여름 초청 행사 운영 계획 수립. 초청장 발송, 행사장 구성, 퍼스널 쇼핑 서비스 운영 방안 포함."),
        t("여름 배너 디자인 시안 검토", "marketing", "M", "양준식", 3, "inprog",
          desc="매장 내외부 배너 디자인 시안 2종 검토. 브랜드 가이드라인 준수 여부 확인 후 외부 업체 시안 최종 결정."),
        t("5월 프로모션 결과 보고서 작성", "marketing", "M", "조정환", -5, "done",
          desc="5월 전층 프로모션 결과 분석 보고서 작성. 참여 고객 수·매출 기여도·ROI 분석 및 향후 개선 방향 포함."),
        t("신규 회원 온보딩 이메일 발송", "marketing", "L", "김지헌", -10, "done",
          desc="신규 앱 가입 고객 대상 웰컴 이메일 발송. 멤버십 혜택 안내·첫 구매 쿠폰 포함. 자동화 시스템 연동 확인 완료."),
        t("8월 추석 프로모션 사전 기획", "marketing", "H", "최영훈", 45, "todo",
          desc="추석 시즌 사전 기획안 작성. 선물 세트 카테고리 구성, 제휴 카드사 할인 협의, 특설 행사장 방향 포함."),
        t("브랜드 협업 마케팅 제안서 작성", "marketing", "M", "이지우", 20, "todo",
          desc="입점 브랜드와의 공동 마케팅 프로모션 제안서 작성. 협업 형태(팝업·콜라보·이벤트), 비용 분담 방식, 기대 효과 수치 포함."),
        t("월간 마케팅 성과 보고 자료 준비", "marketing", "M", "김보람", 6, "inprog",
          desc="6월 마케팅 KPI 종합 성과 자료 작성. SNS 도달수·참여율, 이메일 오픈율, 행사 방문객 수, 매출 기여도 항목별 정리."),

        # ── 영업분석 셀 (10) ─────────────────────────────────────
        t("2F 리뉴얼 CRM 효과 분석", "analysis", "H", "이경미", 3, "inprog", True,
          "리뉴얼 전후 3개월 방문 패턴·구매 전환율 비교 분석. CRM 데이터 기반 보고서 작성 후 팀장 보고."),
        t("3F 월간 매출 현황 보고서", "analysis", "H", "김소영", 0, "inprog",
          desc="3F 층 6월 매출 현황 및 브랜드별 기여도 분석. 전월·전년 동기 대비 증감률 포함하여 팀장 보고."),
        t("1분기 층별 매출 종합 분석", "analysis", "H", "이경미", -30, "done", True,
          "1~3월 층별 매출 데이터 종합 분석. 고·저성장 층 원인 분석 및 브랜드 포트폴리오 최적화 방향 제언 포함."),
        t("VIP 고객 이탈률 원인 분석", "analysis", "H", "김소영", 5, "inprog",
          desc="최근 6개월 구매 이력 없는 VIP 이탈 고객 분석. 온라인 전환·경쟁사 이동 등 가설 검증 후 재유입 전략 제안."),
        t("5월 KPI 대시보드 업데이트", "analysis", "M", "이경미", -2, "done",
          desc="5월 팀 KPI 실적 입력 및 대시보드 업데이트. 누적 달성률 표시, 수정 필요 항목 표기 후 팀장 공유."),
        t("층별 임대 수익성 비교 분석", "analysis", "M", "김소영", 15, "todo",
          desc="층별 임대 단가 대비 수익성 비교 분석. 하위 층 원인 파악 및 임대 조건 재협의 필요성 검토 보고."),
        t("신규 입점 브랜드 매출 기여도 분석", "analysis", "H", "이경미", 4, "inprog",
          desc="금년 신규 입점 5개 브랜드 월별 매출 추이 분석. 재계약·퇴점 의사결정 참고 자료로 활용."),
        t("고객 재방문율 3개월 추이 분석", "analysis", "M", "김소영", 10, "todo",
          desc="3~5월 고객 재방문율 추이 분석. 등급별 재방문 패턴 차이 분석 후 재방문율 향상 마케팅 연계 방안 제안."),
        t("6월 프로모션 ROI 사전 추정", "analysis", "H", "이경미", 1, "todo",
          desc="6월 여름 프로모션 투입 비용 대비 기대 매출 증분 분석. 손익분기점 도출 후 프로모션 규모 결정 의사결정 지원."),
        t("경쟁 백화점 벤치마킹 조사", "analysis", "M", "김소영", -20, "done",
          desc="롯데본점·현대·신세계 최근 행사 및 서비스 동향 현장 조사. 차별화 포인트 및 벤치마킹 적용 사례 정리."),

        # ── 온라인 셀 (10) ───────────────────────────────────────
        t("앱 푸시 A/B 테스트 설계", "online", "M", "안창모", 5, "todo",
          desc="앱 알림 문구 2종 A/B 테스트 설계. 발송 시간대·타겟 세그먼트·오픈율·클릭률 측정 지표 설정 후 마케팅팀과 협의."),
        t("온라인몰 여름 시즌 UI 개편 검토", "online", "H", "백지혜", 10, "inprog",
          desc="온라인몰 메인 화면 여름 UI 개편 방향 검토. 사용자 행동 데이터 분석 기반 배너 위치 최적화·여름 카테고리 전면 노출 방안 포함."),
        t("모바일 앱 6월 업데이트 QA 테스트", "online", "M", "안창모", 3, "inprog",
          desc="모바일 앱 6월 업데이트 버전 QA 수행. iOS/Android 주요 기능 확인, 결제 프로세스 테스트, 버그 리포트 작성 후 개발팀 전달."),
        t("온라인 전용 여름 할인 이벤트 기획", "online", "H", "백지혜", 7, "todo",
          desc="앱·웹 전용 여름 특가 이벤트 기획. 72시간 한정 특가·선착순 쿠폰·장바구니 할인 등 온라인 전용 혜택 구성."),
        t("상품 상세페이지 SEO 최적화 작업", "online", "L", "안창모", -15, "done",
          desc="주요 카테고리 상품 상세페이지 SEO 최적화. 키워드 분석, 메타 태그 수정, 이미지 alt 태그 추가 및 모바일 최적화 확인."),
        t("신상품 이미지 업로드 및 등록", "online", "M", "백지혜", 2, "inprog",
          desc="6월 신상품 이미지 리사이징 및 온라인몰 등록. 상품 설명·사이즈·가격 정보 정확성 검수 후 라이브 전환."),
        t("온라인 고객 리뷰 모니터링 및 대응", "online", "L", "안창모", -5, "done",
          desc="온라인몰 상품 리뷰 모니터링 및 부정 리뷰 대응. 별점 3점 이하 리뷰 분류, CS팀 연계 처리, 반복 불만 유형 정리."),
        t("앱 이용자 행동 데이터 분석", "online", "M", "백지혜", 12, "todo",
          desc="월간 앱 이용자 행동 로그 분석. 주요 이탈 지점·인기 카테고리·검색 키워드 Top 20 분석 후 UX 개선 우선순위 제안."),
        t("퀵배송 서비스 운영 프로세스 개선", "online", "H", "안창모", 8, "inprog",
          desc="퀵배송 지연·오배송 원인 분석. 물류센터 협의, 배차 시스템 개선, SLA 재설정 포함한 개선안 도출."),
        t("6월 온라인 전용 쿠폰 발급 기획", "online", "M", "백지혜", -3, "done",
          desc="6월 온라인 전용 할인 쿠폰 기획. 쿠폰 종류·사용 카테고리·유효 기간·발급 조건 설정 후 시스템 등록 요청."),

        # ── MD팀 (10) ────────────────────────────────────────────
        t("신규 브랜드 입점 협의", "md", "H", "손지현", 1, "inprog", True,
          "잠재 입점 후보 브랜드와 입점 조건 협상. 매출 보증금, 수수료율, 매장 면적, 인테리어 투자 분담 등 계약 주요 조건 협의."),
        t("MD 행사 상품 리스트 작성", "md", "M", "김보향", 9, "todo",
          desc="6월 프로모션 행사 상품 리스트 작성. 브랜드별 참여 상품 확정, 할인율 협의, 재고 확보 여부 확인 후 마케팅팀 전달."),
        t("입점 브랜드 5월 매출 정산 확인", "md", "H", "손지현", -5, "done",
          desc="입점 브랜드 5월 매출 데이터 시스템 대조 및 정산 확인. 브랜드별 이의 신청 처리 후 최종 정산서 발송."),
        t("A브랜드 계약 갱신 협상", "md", "H", "김보향", 15, "inprog",
          desc="A브랜드 연간 입점 계약 갱신 협상 진행 중. 수수료율 조정, 계약 기간 연장, 추가 인센티브 조건 협의."),
        t("식품관 신규 카테고리 입점 검토", "md", "M", "손지현", 20, "todo",
          desc="식품관 건강식품·비건 식품 신규 카테고리 입점 타당성 검토. 시장 트렌드 분석, 예상 매출, 필요 면적 및 공사 비용 산출 포함."),
        t("해외 명품 브랜드 수입 타당성 검토", "md", "H", "김보향", 35, "todo",
          desc="유럽 명품 브랜드 3개사 국내 독점 수입·입점 타당성 분석. 브랜드 인지도, 가격대, 경쟁사 보유 여부, 예상 매출 규모 보고."),
        t("3F 매장 레이아웃 변경 기획", "md", "M", "손지현", 12, "inprog",
          desc="3F 고객 동선 최적화를 위한 레이아웃 변경 기획. 입점 브랜드 배치 조정, 체류 시간 향상 방안, 공사 일정 및 비용 산출 포함."),
        t("F/W 시즌 상품 구성 기획", "md", "H", "김보향", 50, "todo",
          desc="가을·겨울 시즌 상품 구성 기획. 브랜드별 컨셉 확인, 주력 카테고리 선정, 소싱 일정 역산하여 8월 확정 목표."),
        t("입점 브랜드 6월 VMD 지도", "md", "M", "손지현", 5, "inprog",
          desc="입점 브랜드 6월 VMD 기준 준수 여부 점검 및 지도. 주요 상품 전면 배치·디스플레이 연출 피드백 제공."),
        t("여름 기획 행사 공간 배치 계획", "md", "M", "김보향", -3, "done",
          desc="6월 여름 기획 행사 특설 공간 배치 계획 수립. 브랜드별 면적 배분, 동선 설계, 행사장 설치 일정 협의 완료."),
    ]
...
def seed_memos():
    return [
        # ── 회의록 1 ──────────────────────────────────────────────
        {"id": new_id(), "title": "6월 전략 회의록",
         "content": (
             "일시: 2026년 6월 3일(수) 14:00\n"
             "참석: 팀장, 마케팅 유닛, 영업분석 셀, 온라인 셀, MD팀\n\n"
             "■ 안건 1. 여름 프로모션 추진 현황\n"
             "- 6월 7~15일 전층 동시 진행 확정\n"
             "- 마케팅: SNS·카카오채널 사전 예고 콘텐츠 3종 제작 (담당: 이지우, 김보람)\n"
             "- MD팀: 참여 브랜드 최종 리스트 6/5까지 제출\n\n"
             "■ 안건 2. 2분기 매출 현황 공유\n"
             "- 영업분석 보고: 전년 동기 대비 +7.2% 달성\n"
             "- 온라인 채널 기여도 전분기 대비 +2.1%p 상승\n\n"
             "■ 안건 3. 7월 VIP 초청 행사 사전 기획\n"
             "- 일시: 7월 14일(화) 예정 / 초청 규모: VIP 200명\n"
             "- 총괄: 이지우(마케팅 유닛)\n\n"
             "■ Action Items\n"
             "- 이지우: 여름 프로모션 SNS 콘텐츠 시안 6/5까지 공유\n"
             "- 김보향: 참여 브랜드 리스트 6/5까지 제출\n"
             "- 이경미: 6월 KPI 목표치 재설정 자료 6/6까지 배포"
         ),
         "date": today_str(0), "cell": "marketing", "shared": True, "shared_branch": False},

        # ── 회의록 2 ──────────────────────────────────────────────
        {"id": new_id(), "title": "마케팅 유닛 주간 회의록",
         "content": (
             "일시: 2026년 6월 1일(월) 10:00\n"
             "참석: 이지우, 김보람, 신석호, 백서희, 양준식, 조정환, 김지헌, 최영훈\n\n"
             "■ 주간 업무 현황\n"
             "- 이지우: 여름 프로모션 기획서 초안 완료, 금주 팀장 보고 예정\n"
             "- 김보람: 카카오채널 발송 리스트 정제 진행 중 (완료율 60%)\n"
             "- 신석호: 인스타그램 여름 콘텐츠 기획안 검토 요청\n"
             "- 백서희: 배너 디자인 시안 2종 제작 완료, 팀 검토 예정\n\n"
             "■ 이슈\n"
             "- 양준식: 제휴 마케팅 파트너사 미팅 6/8 예정\n"
             "- 조정환: SNS 광고 예산 재검토 필요 → 팀장 확인 요청\n\n"
             "■ 다음주 중점 업무\n"
             "- 여름 프로모션 최종 기획안 확정\n"
             "- VIP 초청 행사 사전 준비 착수\n"
             "- 뉴스레터 6월호 콘텐츠 마무리 (담당: 김지헌)"
         ),
         "date": today_str(-2), "cell": "marketing", "shared": False, "shared_branch": False},

        # ── 점장님 지시사항 1 ─────────────────────────────────────
        {"id": new_id(), "title": "[점장 지시] 고객 서비스 품질 강화",
         "content": (
             "전달일: 2026년 5월 28일\n\n"
             "1. 고객 응대 기본 매뉴얼 전 직원 재숙지\n"
             "   - 고객 입장 시 3초 이내 인사 의무화\n"
             "   - 불만 고객 응대 시 즉시 관리자 보고 원칙 준수\n\n"
             "2. 매장 청결 기준 상향\n"
             "   - 오전·오후 각 1회 구역별 점검 실시\n"
             "   - 점검 결과 주간 보고서로 제출\n\n"
             "3. 기타\n"
             "   - 영업 종료 30분 전 고객 안내 방송 강화\n"
             "   - 분실물 처리 절차 재확인 및 숙지\n\n"
             "■ 이행 기한: 2026년 6월 10일\n"
             "■ 담당: 각 셀·유닛장"
         ),
         "date": today_str(-5), "cell": "marketing", "shared": True, "shared_branch": True},

        # ── 점장님 지시사항 2 ─────────────────────────────────────
        {"id": new_id(), "title": "[점장 지시] 6월 매출 목표 달성 독려",
         "content": (
             "전달일: 2026년 6월 2일\n\n"
             "상반기 마지막 달, 6월 목표 달성을 위해 아래 사항 즉시 이행 바랍니다.\n\n"
             "1. 핵심 상품 전면 배치 재검토\n"
             "   - 이달 목표 상품군 플로어 상단 노출 극대화\n"
             "   - VMD 긴급 점검 후 3일 이내 조정 완료\n\n"
             "2. 일별 매출 모니터링 강화\n"
             "   - 매일 오후 5시 일일 매출 현황 팀장 보고\n"
             "   - 목표 대비 80% 미달 시 즉시 원인 분석 및 대책 보고\n\n"
             "3. 직원 동기부여\n"
             "   - 월말 목표 달성 시 포상 계획 있음 (인사팀 별도 공지)\n"
             "   - 팀별 일일 현황판 운영으로 진척도 공유\n\n"
             "■ 시행: 즉시\n"
             "■ 문의: 영업기획팀 팀장"
         ),
         "date": today_str(-1), "cell": "analysis", "shared": True, "shared_branch": True},

        # ── 대표이사님 방문 공유사항 ──────────────────────────────
        {"id": new_id(), "title": "[공유] 대표이사님 인천점 방문 일정",
         "content": (
             "■ 방문 일정\n"
             "일시: 2026년 6월 10일(수) 오전 11:00\n"
             "목적: 하반기 사업 현황 점검 및 격려 방문\n"
             "수행: 대표이사님, 부사장님, 영업본부장님\n\n"
             "■ 당일 일정\n"
             "- 11:00 영업기획팀 상반기 성과 보고 (팀장 주관)\n"
             "- 11:30 주요 플로어 현장 방문\n"
             "- 12:00 중식 (VIP 라운지)\n\n"
             "■ 팀별 준비사항\n"
             "- 영업기획팀: 상반기 성과·하반기 계획 보고자료 준비 (담당: 이경미)\n"
             "- 각 셀·유닛: 담당 구역 집중 정비 (6/9까지 완료)\n"
             "- 마케팅: 환영 현수막 및 브랜딩 소품 준비 (담당: 신석호)\n\n"
             "■ 복장: 정장 착용 의무\n"
             "※ 본 내용은 대외비이므로 외부 유출 금지"
         ),
         "date": today_str(-1), "cell": "marketing", "shared": True, "shared_branch": True},
    ]
